...
public class ComputerEngineer2 {
    ...
    public void makeComputer(String productFamily){
        /**
         * 组装机器的基本步骤
         */
        //1:首先准备好装机所需要的配件
        prepareHardwares(productFamily);
        //2:组装机器
        //3:测试机器
        //4：交付客户
    }

    private void prepareHardwares(String productFamily){
        //这里要去准备CPU和主板的具体实现，为了示例简单，这里只准备这两个
        //可是，装机工程师并不知道如何去创建，怎么办呢？

        //直接找相应的工厂获取
        ComputerFactory computerFactory = new ComputerFactory();
        this.cpu = ComputerFactory.createCpu(productFamily);
        this.mainboard = ComputerFactory.createMainboard(productFamily);
